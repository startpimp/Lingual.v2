...
async function run(req, res) {
	...
	await MYSQL.editComponent(Q_COMPONENT, Q_LANGUAGE, Q_TYPE, COMPONENT, READING, ORIGIN, HIDDEN_TYPES, HIDDEN_PRONUNCIATIONS, HIDDEN_TRANSLATIONS, HIDDEN_DEFINITIONS)
