...
async function run(req, res) {
	...
	await MYSQL.addComponent(COMPONENT, READING, ORIGIN, HIDDEN_TYPES, HIDDEN_PRONUNCIATIONS, HIDDEN_TRANSLATIONS, HIDDEN_DEFINITIONS, HIDDEN_SYNONYMS, HIDDEN_ANTONYMS)
